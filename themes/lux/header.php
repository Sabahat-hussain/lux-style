...
<div id="page" class="site">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<ul class="announcement-bar__list pt-2 pb-2">
					
					<li><i class="bi bi-telephone rounded-circle"></i>
					<a href="tel: 416-785 4323">416-785 4323</a>
					</li>

					<li><i class="bi bi-envelope rounded-circle"></i>
					<a href="mailto:hello@luxstyle.shop">hello@luxstyle.shop</a>
					</li>
			...
			<ul class="announcement-bar__list">
					...
					<li><i class="bi bi-clock-history rounded-circle"></i>
	...
	<div class="container d-flex justify-content-center">
	 ...
	 <div class="row">
		 <div class="col-12 d-flex justify-content-center">
			 ...
			 <?php esc_html_e( 'Primary Menu', 'luxstyle'); ?>
			</button>-->
		 </div>
